/**
 * 28 - Antialiasing and Multisampling
 */
...
bool init() {
  ...
  // to enable this on sdl, see Remarks at https://wiki.libsdl.org/SDL_GLattr#multisample
  ...
  gWindow = LWindow_new("28 - Antialiasing and Multisampling", SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_OPENGL, 0);
  if (gWindow == NULL) {
