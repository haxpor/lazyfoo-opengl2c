/**
 * 27 - Frame Buffer Objects and Render to Texture
 */
...
bool init() {
  ...
  gWindow = LWindow_new("27 - Frame Buffer Objecs and Render to Texture", SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_OPENGL, 0);
  if (gWindow == NULL) {
