...
void gl_LTexture_render(gl_LTexture* texture, GLfloat x, GLfloat y, const LFRect* clip, const LFSize* stretch, GLfloat degrees)
{
  // texture coordinates
  ...
  // move to rendering position and at the center of the image
  // this will accomodate rotation as well
  glTranslatef(x + quad_width/2.f, y + quad_height/2.f, 0.f);
  ...
  // render texture quad
  glBegin(GL_QUADS);
    glTexCoord2f(tex_left, tex_top); glVertex2f(-quad_width/2.f, -quad_height/2.f);
    glTexCoord2f(tex_right, tex_top); glVertex2f(quad_width/2.f, -quad_height/2.f);
    glTexCoord2f(tex_right, tex_bottom); glVertex2f(quad_width/2.f, quad_height/2.f);
    glTexCoord2f(tex_left, tex_bottom); glVertex2f(-quad_width/2.f, quad_height/2.f);
  glEnd();
