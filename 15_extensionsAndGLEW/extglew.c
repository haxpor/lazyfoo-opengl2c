...
bool init() {
  ...
  gWindow = LWindow_new("15 - Extensions and GLEW", SCREEN_WIDTH, SCREEN_HEIGHT, SDL_WINDOW_OPENGL, 0);
  if (gWindow == NULL) {
  ...
  // this mean we have at least opengl 2.1 core functionality
  if (!GLEW_VERSION_2_1)
  {
