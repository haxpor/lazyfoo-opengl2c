...
bool usercode_loadmedia()
{
  ...
  quad_vertices[0].x = g_logical_width * 1.f / 4.f;
  quad_vertices[0].y = g_logical_height * 1.f / 4.f;

  quad_vertices[1].x = g_logical_width * 3.f / 4.f;
  quad_vertices[1].y = g_logical_height * 1.f / 4.f;

  quad_vertices[2].x = g_logical_width * 3.f / 4.f;
  quad_vertices[2].y = g_logical_height * 3.f / 4.f;

  quad_vertices[3].x = g_logical_width * 1.f / 4.f;
  quad_vertices[3].y = g_logical_height * 3.f / 4.f;
  ...
  // with this call we create the buffer then send them to GPU
  glBufferData(GL_ARRAY_BUFFER, 4 * sizeof(LFVector2D), quad_vertices, GL_STATIC_DRAW);
  // unbind
